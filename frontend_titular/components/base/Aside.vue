    ...
    >
      <div class="sidenav-header">
        ...
        >
          ...
          <span class="ms-0 font-weight-bold">Electronica Arielito-Dashboard</span>
        </a>
      </div>
              ...
              <ul class="nav ms-4 ps-3">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                  <nuxtLink
                    class="nav-link"
                    to="/persona/distritos"
                  >
                    <span class="sidenav-mini-icon"> D </span>
                    <span class="sidenav-normal"> Distritos </span>
                  </nuxtLink>
                </li>
          <li class="nav-item">
                  <nuxtLink
                  ...
                  >
                    ...
                    <span class="sidenav-normal"> Factura </span>
                  </nuxtLink>
                </li>
