...
class InventarioController extends Controller
{
    ...
    public function kardex(Articulo $articulo)
    {
        ...
        foreach ($articulo->inventarios as $inventario) {
            $inventario->updated_at_formatted = $inventario->updated_at->format('d-m-Y');
        }
    ...
    public function store(Request $request)
    {
        ...
        $inventario->comprobante = $request->comprobante;
        $inventario->save();
        return $inventario;
    }
